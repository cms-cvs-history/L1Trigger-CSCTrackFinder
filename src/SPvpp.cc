...
for (int i = 1; i >= 0; i--)
{
	...
	Wire_(etaoff1, BWETAIN-1, 0); 
	Wire_(etaoff2, BWETAIN-1, 0); 
	Wire_(etaoff3, BWETAIN-1, 0); 
	Wire_(etaoff4, BWETAIN-1, 0); 
	...
	me1idH = idHp(MUIDME1-1, bp).getint();		//Me1 from 0->5
	me1idM = idMp(MUIDME1-1, bp).getint();
	me1idL = idLp(MUIDME1-1, bp).getint();

	bp += MUIDME1;

	me2idH = idHp(bp + MUIDME234 - 1, bp).getint();	//Me2 from 6->8
	me2idM = idMp(bp + MUIDME234 - 1, bp).getint();
	me2idL = idLp(bp + MUIDME234 - 1, bp).getint();

	bp += MUIDME234;

	me3idH = idHp(bp + MUIDME234 - 1, bp).getint();	//Me3 from 9->11
	me3idM = idMp(bp + MUIDME234 - 1, bp).getint();
	me3idL = idLp(bp + MUIDME234 - 1, bp).getint();

	bp += MUIDME234;

	me4idH = idHp(bp + MUIDME234 - 1, bp).getint();	//Me4 from 12->14
	me4idM = idMp(bp + MUIDME234 - 1, bp).getint();
	me4idL = idLp(bp + MUIDME234 - 1, bp).getint();

	bp += MUIDME234;

	mb1idH = idHp(bp + MUIDMB12 - 1, bp).getint();
	mb1idM = idMp(bp + MUIDMB12 - 1, bp).getint();
	mb1idL = idLp(bp + MUIDMB12 - 1, bp).getint();

	bp += MUIDMB12;

	mb2idH = idHp(bp + MUIDMB12 - 1, bp).getint();
	mb2idM = idMp(bp + MUIDMB12 - 1, bp).getint();
	mb2idL = idLp(bp + MUIDMB12 - 1, bp).getint();
