...
initio
	...
	pt0.input(BWPT-1,0,"pt0"); sign0.input("sign0"); modeMem0.input(BWMODE-1,0,"modeMem0"); etaPT0.input(BWETAOUT-1,0,"etaPT0"); FR0.input("FR0"); phi0.input(BWPHI-1,0,"phi0"); 
	pt1.input(BWPT-1,0,"pt1"); sign1.input("sign1"); modeMem1.input(BWMODE-1,0,"modeMem1"); etaPT1.input(BWETAOUT-1,0,"etaPT1"); FR1.input("FR1"); phi1.input(BWPHI-1,0,"phi1"); 
	pt2.input(BWPT-1,0,"pt2"); sign2.input("sign2"); modeMem2.input(BWMODE-1,0,"modeMem2"); etaPT2.input(BWETAOUT-1,0,"etaPT2"); FR2.input("FR2"); phi2.input(BWPHI-1,0,"phi2"); 
	pt3.input(BWPT-1,0,"pt3"); sign3.input("sign3"); modeMem3.input(BWMODE-1,0,"modeMem3"); etaPT3.input(BWETAOUT-1,0,"etaPT3"); FR3.input("FR3"); phi3.input(BWPHI-1,0,"phi3"); 
	pt4.input(BWPT-1,0,"pt4"); sign4.input("sign4"); modeMem4.input(BWMODE-1,0,"modeMem4"); etaPT4.input(BWETAOUT-1,0,"etaPT4"); FR4.input("FR4"); phi4.input(BWPHI-1,0,"phi4"); 
	pt5.input(BWPT-1,0,"pt5"); sign5.input("sign5"); modeMem5.input(BWMODE-1,0,"modeMem5"); etaPT5.input(BWETAOUT-1,0,"etaPT5"); FR5.input("FR5"); phi5.input(BWPHI-1,0,"phi5"); 
	pt6.input(BWPT-1,0,"pt6"); sign6.input("sign6"); modeMem6.input(BWMODE-1,0,"modeMem6"); etaPT6.input(BWETAOUT-1,0,"etaPT6"); FR6.input("FR6"); phi6.input(BWPHI-1,0,"phi6"); 
	pt7.input(BWPT-1,0,"pt7"); sign7.input("sign7"); modeMem7.input(BWMODE-1,0,"modeMem7"); etaPT7.input(BWETAOUT-1,0,"etaPT7"); FR7.input("FR7"); phi7.input(BWPHI-1,0,"phi7"); 
	pt8.input(BWPT-1,0,"pt8"); sign8.input("sign8"); modeMem8.input(BWMODE-1,0,"modeMem8"); etaPT8.input(BWETAOUT-1,0,"etaPT8"); FR8.input("FR8"); phi8.input(BWPHI-1,0,"phi8"); 
	...
	ptH.output(BWPT-1,0,"ptH",makereg); signH.output("signH",makereg); modeMemH.output(BWMODE-1,0,"modeMemH",makereg); etaPTH.output(BWETAOUT-1,0,"etaPTH",makereg); FRH.output("FRH",makereg); phiH.output(BWPHIOUT-1,0,"phiH",makereg);
	ptM.output(BWPT-1,0,"ptM",makereg); signM.output("signM",makereg); modeMemM.output(BWMODE-1,0,"modeMemM",makereg); etaPTM.output(BWETAOUT-1,0,"etaPTM",makereg); FRM.output("FRM",makereg); phiM.output(BWPHIOUT-1,0,"phiM",makereg);
	ptL.output(BWPT-1,0,"ptL",makereg); signL.output("signL",makereg); modeMemL.output(BWMODE-1,0,"modeMemL",makereg); etaPTL.output(BWETAOUT-1,0,"etaPTL",makereg); FRL.output("FRL",makereg); phiL.output(BWPHIOUT-1,0,"phiL",makereg); 
...
beginmodule
	...
	(
		...
		pt0 or sign0 or modeMem0 or etaPT0 or FR0 or phi0 or 
		pt1 or sign1 or modeMem1 or etaPT1 or FR1 or phi1 or 
		pt2 or sign2 or modeMem2 or etaPT2 or FR2 or phi2 or 
		pt3 or sign3 or modeMem3 or etaPT3 or FR3 or phi3 or 
		pt4 or sign4 or modeMem4 or etaPT4 or FR4 or phi4 or 
		pt5 or sign5 or modeMem5 or etaPT5 or FR5 or phi5 or 
		pt6 or sign6 or modeMem6 or etaPT6 or FR6 or phi6 or 
		pt7 or sign7 or modeMem7 or etaPT7 or FR7 or phi7 or 
		pt8 or sign8 or modeMem8 or etaPT8 or FR8 or phi8 or
